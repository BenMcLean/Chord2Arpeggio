...
Inputs a guitar chord name and outputs a series of numbers for how many half steps apart the notes are.
This facilitates creating arpeggios for the chords in FamiStudio. https://famistudio.org/
